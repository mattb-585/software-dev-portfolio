...
<div class="row row-cols-1 row-cols-md-3">
  <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if( strpos($product['name'], 'Mug') == true ): ?>
        <div class="col mb-4">
            <div class="card">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Matt/Documents/Software_Dev_Portfolio/PHP & Laravel Experience/FinalProject/resources/views/mugs.blade.php ENDPATH**/ ?>